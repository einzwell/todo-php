...
<div class="container">
    ...
    <div>
        ...
        <p>
            For more information, please check out the <a href="https://github.com/einzwell/todo.php">GitHub repository.</a>
        </p>

        <h3>Credits</h3>
        <p>
            This app is created by Yoga Smara (<a href="https://einzwell.dev">@einzwell</a>)
    </div>
</div>
